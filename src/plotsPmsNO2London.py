...
plt.xlabel('utc_time')
plt.ylabel('PM2.5 Level')
plt.title('PM2.5 from 2017/06/05 00:00:00 to 2017/06/25 23:00:00 (over three weeks)')
plt.show()
...
plt.title('PM10 from 2017/06/05 00:00:00 to 2017/06/25 23:00:00 (over three weeks)')
plt.show()
...
plt.title('NO2 from 2017/06/05 00:00:00 to 2017/06/25 23:00:00 (over three weeks)')
plt.show()
